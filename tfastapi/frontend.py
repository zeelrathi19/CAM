...
st.markdown("Upload an image to detect **Trucks** and **Tyres** within the L-shape zone.")
...
with col1:
    ...
    uploaded_file = st.file_uploader(
        "Choose an image...",
        type=["jpg", "jpeg", "png"],
        help="Upload an image to detect trucks and tyres"
    )
